...
import { mdiBrain, mdiCloudUpload } from "@mdi/js";
      ...
      >
        ...
        >
          <div className={classes.gridItem}>
            <MdiIcon path={mdiBrain} size={4} color="white" />
